    ...
    <ScrollView style={styles.container}>
        ...
        <ScrollView horizontal pagingEnabled>
          {orphanage.images.map(image => {
            return (
              ...
              key={image.id}
              style={styles.image} 
              //nescessario trocar endereco e porta no aquivo view-iamge.ts no backend caso não funcione
      ...
      <View style={styles.detailsContainer}>
        ...
        <View style={styles.mapContainer}>
          ...
          <TouchableOpacity onPress={openGoogleMapRoutes}  style={styles.routesContainer}>
